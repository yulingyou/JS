...
form.addEventListener("submit", (e)=>{
    ...
    if (email.trim() !== "" && password.trim() !== "") {
        ...
        //       console.log(err)
        //     })
        _axiosDefault.default.post("https://todoo.5xcamp.us/users", userData).then(({ data  })=>{
            console.log(data);
...
loginform.addEventListener("submit", (e)=>{
    ...
    if (email.trim() !== "" && password.trim() !== "") {
        ...
        _axiosDefault.default.post("https://todoo.5xcamp.us/users/sign_in", userData).then((resp)=>{
...
document.querySelector("#checkForm").addEventListener("submit", (e)=>{
    ...
    if (token) _axiosDefault.default.get("https://todoo.5xcamp.us/check", {
        headers: {
            Authorization: token
        }
    }).then((resp)=>{
...
document.querySelector("#logOutForm").addEventListener("submit", (e)=>{
    e.preventDefault();
    const token = localStorage.getItem("recordToken");
    _axiosDefault.default.delete("https://todoo.5xcamp.us/users/sign_out", {
        headers: {
            Authorization: token
        }
    }).then((resp)=>{
...
document.querySelector("#todoForm").addEventListener("submit", (e)=>{
    ...
    _axiosDefault.default.post("https://todoo.5xcamp.us/users/todos", todoData, {
        headers: {
            Authorization: token
        }
    }).then((data)=>{
...
document.querySelector("#todoForm").addEventListener("submit", (e)=>{
    e.preventDefault();
    const todo1 = document.querySelector("#todoInput");
    const token = localStorage.getItem("todo-token");
    const todoData = {
        todo: {
            content: todo1.value.trim()
        }
    };
    _axiosDefault.default.post("https://todoo.5xcamp.us/todos", todoData, {
        headers: {
            Authorization: token
        }
    }).then(({ data  })=>{
        const li1 = document.querySelector("#todoInput");
...
},{}]},["d5kvp","igcvL"], "igcvL", "parcelRequiref536")

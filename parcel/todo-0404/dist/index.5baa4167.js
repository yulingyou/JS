...
form.addEventListener("submit", function(e) {
    ...
    if (email.value.trim() !== "" && password.value.trim() !== "") {
        ...
        _axiosDefault.default.post('https://todoo.5xcamp.us/users', userData).then(function(resp) {
...
loginForm.addEventListener("submit", function(e) {
    ...
    if (email.value.trim() !== "" && password.value.trim() !== "") {
        ...
        _axiosDefault.default.post('https://todoo.5xcamp.us/users/sign_in', userData).then(function(resp) {
            const token1 = resp.headers.authorization;
            //   document.querySelector("#token").value = token
            localStorage.setItem("todo-token", token1);
            console.log("登入成功");
        }).catch((err)=>{
            console.log(err);
        });
...
checkForm.addEventListener("submit", function(e) {
    ...
    console.log(token);
    if (token) _axiosDefault.default.get('https://todoo.5xcamp.us/check', checkData).then(({ data  })=>{
...
},{}]},["d5kvp","igcvL"], "igcvL", "parcelRequiree586")
